...
from src.models.database import db, Order, Payment, User
import uuid
    ...
    def process_payment(amount, payment_method, card_data=None):
        ...
        if payment_method == 'credit_card':
            ...
            return {
                'success': True,
                'payment_id': payment_id,
                'boleto_code': f'34191.79001 01043.510047 91020.150008 4 84410026000',
                'amount': amount,
                'status': 'pending',
                'due_date': '2025-07-10'
            }
    ...
    try:
        ...
        return jsonify({
            'payment': {
                ...
                'gateway_response': json.loads(payment.gateway_response) if payment.gateway_response else None
            }
        })
...
def refund_payment(payment_id):
    ...
    try:
        ...
        if payment.status != 'approved':
            return jsonify({'error': 'Apenas pagamentos aprovados podem ser reembolsados'}), 400
