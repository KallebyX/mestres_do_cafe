...
class BaseController:
    ...
    def search(self, search_fields: List[str], query_param: str = 'q'):
        ...
        try:
            ...
            # Sanitizar search_term para prevenir SQL injection
            safe_search_term = search_term.replace('%', '\\%').replace('_', '\\_')
            ...
            for field in search_fields:
                if hasattr(self.model, field):
                    ...
                    search_conditions.append(column.ilike(f'%{safe_search_term}%'))
