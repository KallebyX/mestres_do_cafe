import { ArrowRight, CheckCircle, Coffee, Eye, EyeOff, Lock, Mail, Shield, Star } from 'lucide-react';
...
const LoginPage = () => {
  ...
  const { login, profile, getUserProfile, isAdmin } = useAuth();
  ...
  // Removido login com Google - usando apenas nossa API
      ...
      <div className="grid lg:grid-cols-2 min-h-screen">
        ...
        <div className="flex flex-col justify-center p-8 lg:p-12">
          <div className="max-w-md w-full mx-auto">
            ...
            {/* Login com Google removido - usando apenas nossa API */}
